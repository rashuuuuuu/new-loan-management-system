    ...
    public void totalPayablePerMonth(String loanNumber) {
        ...
        for (int i = 0; i < tenureMonth; i++) {
            ...
            TotalPayableEntity totalPayableEntity = totalPayableRepository
                ...
                totalPayableEntity.setPayableInterest( totalPayableEntity.getPaidInterest()>0?0D:calculateTotalInterestPerMonth(loanNumber, i + 1));
                ...
                if (Boolean.TRUE.equals(schedule.getLastInstallment())) {
                    ...
                    Double payableInterest = totalPayableEntity.getPaidInterest()>0?0D:calculateTotalInterestPerMonth(loanNumber, tenureMonth);
