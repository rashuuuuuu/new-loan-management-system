...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public CustomerResponse getCustomerByBankCodeAndCustomerNumber(BankIdAndCustomerRequest req) {
        log.info("Searching for customerNumber={} in bankCode={}", req.getCustomerNumber(), req.getBankCode());

        Customer customer = customerRepository
                .findCustomerByBankCodeAndCustomerNumber(req.getBankCode(), req.getCustomerNumber())
